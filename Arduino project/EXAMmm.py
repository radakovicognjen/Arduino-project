...
CHANNEL_ID = '2015769'
API_KEY_WRITE = 'QYY9VPPUXM2AN0XZ'
API_KEY_READ = 'WNN3GL46RTQ88SNK'
...
def sendReport():
    ...
    plt.savefig('C:\\Users\\radak\\Desktop\\examOgnjenRadakovic\\' + fileName)

    tempGraph    = open('C:\\Users\\radak\\Desktop\\examOgnjenRadakovic\\' + fileName, 'rb')
    msgTempGraph = MIMEImage(tempGraph.read()) #to add image at our attachment
    tempGraph.close()
    message.attach(msgTempGraph)
    
    IllumGraph    = open('C:\\Users\\radak\\Desktop\\examOgnjenRadakovic\\' + fileName, 'rb')
    ...
    MotionGraph    = open('C:\\Users\\radak\\Desktop\\examOgnjenRadakovic\\' + fileName, 'rb')
